...
"------------------------------------
if s:neobundled('operator-camelize.vim')
    " camel-caseへの変換
...
"------------------------------------
if s:neobundled('vim-operator-replace')
...
"------------------------------------
if s:neobundled('vim-operator-surround')
...
" neosnippet.vim
"------------------------------------
if s:neobundled('neosnippet.vim')
    " Plugin key-mappings
